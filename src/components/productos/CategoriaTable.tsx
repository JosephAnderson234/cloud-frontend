import type { CategoriaTableProps } from '@interfaces/productosComponents';

export default function CategoriaTable({ categorias, onEdit, onDelete, loading }: CategoriaTableProps) {
    if (loading) {
        return (
    ...
    if (categorias.length === 0) {
        return (
            <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                ...
                <p className="text-gray-500">Comienza creando tu primera categoría de productos.</p>
            </div>
        );
    }
