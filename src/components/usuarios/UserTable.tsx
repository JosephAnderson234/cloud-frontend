import type { UserTableProps } from '@interfaces/usuariosComponents';

export default function UserTable({ usuarios, onEdit, onDelete, onViewDirections, loading }: UserTableProps) {
    if (loading) {
        return (
                            ...
                            <tr key={usuario.id_usuario} className="hover:bg-gray-50 transition-colors">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div className="flex justify-end space-x-2">
                                        <button
                                            onClick={() => onViewDirections(usuario.id_usuario)}
